  ...
  <body>
    ...
    <form>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="sku" id="exampleInputPassword1">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Descrição do Produto</label>
            <textarea for="exampleInputPassword1" class="form-control" rows="10" name="description" class="form-label"></textarea>
          </div>
